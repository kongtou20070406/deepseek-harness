...
| [`context/`](context/README.md) | Model-visible request context, including workspace instructions, time context, and selective research history | Product — stable API |
