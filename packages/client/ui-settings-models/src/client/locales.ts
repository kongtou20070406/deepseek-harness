...
export const en = {
  ...
  codexTitle: 'OpenAI membership',
  codexIntro: 'Use your ChatGPT Plus or Pro subscription for Codex models and view the current subscription meters.',
  codexConnected: 'Connected',
  codexDisconnected: 'Not connected',
  codexLogin: 'Sign in with ChatGPT',
  codexStarting: 'Starting sign-in…',
  codexWaiting: 'Waiting for sign-in…',
  codexDeviceCode: 'Device code',
  codexOpenLogin: 'Open OpenAI sign-in',
  codexRefresh: 'Refresh usage',
  codexRefreshing: 'Refreshing…',
  codexLogout: 'Sign out',
  codexLogoutConfirm: 'Remove the OpenAI membership login from this Harness?',
  codexUsageAria: 'Codex subscription usage',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  codexTitle: 'OpenAI 会员',
  codexIntro: '使用 ChatGPT Plus 或 Pro 订阅调用 Codex 模型，并查看当前订阅额度。',
  codexConnected: '已连接',
  codexDisconnected: '未连接',
  codexLogin: '使用 ChatGPT 登录',
  codexStarting: '正在启动登录…',
  codexWaiting: '等待登录完成…',
  codexDeviceCode: '设备代码',
  codexOpenLogin: '打开 OpenAI 登录页',
  codexRefresh: '刷新用量',
  codexRefreshing: '刷新中…',
  codexLogout: '退出登录',
  codexLogoutConfirm: '从当前 Harness 中移除 OpenAI 会员登录？',
  codexUsageAria: 'Codex 订阅用量',
  codexUsageTitle: 'Codex 用量',
  edit: '编辑',
