...
export const zh = {
  ...
  'image.dropTitle': '将图片或 Markdown 文件拖到此处即可添加',
  ...
  'image.unsupportedType': '仅支持 PNG、JPG、WebP、GIF 图片和 Markdown 文件',
  'file.readFailed': 'Markdown 文件读取失败，请重试',
  ...
  'stats.ttftAverage': '首字 {duration}',
  'stats.tokensPerSecond': '{throughput} tok/s',
  'stats.cacheHit': '缓存 {percent}%',
  'stats.totalTokens': '本对话 {total} tok',
...
export const en = {
  ...
  'image.dropTitle': 'Drag images or Markdown files here to add them',
  ...
  'image.unsupportedType': 'Only PNG, JPG, WebP, and GIF images and Markdown files are supported',
  'file.readFailed': 'Could not read the Markdown file; try again',
  ...
  'stats.totalTokens': 'This chat {total} tok',
