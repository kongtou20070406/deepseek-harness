...
describe('attachment rejection copy', () => {
  ...
  it('maps user-solvable reasons to limit-naming copy', () => {
    ...
    expect(attachmentErrorText(t, 'INVALID_IMAGE')).toBe('仅支持 PNG、JPG、WebP、GIF 图片和 Markdown 文件')
    expect(attachmentErrorText(t, 'IMAGE_TYPE_MISMATCH')).toBe('仅支持 PNG、JPG、WebP、GIF 图片和 Markdown 文件')
