...
export const zh = {
  ...
  'deleteSession.desc': '将永久删除会话“{name}”及其全部记录，此操作无法撤销。',
  'deleteSession.confirm': '永久删除',
  'deleteSession.pending': '正在永久删除会话…',
...
export const en = {
  ...
  'deleteSession.desc': 'This permanently deletes “{name}” and all its history. This cannot be undone.',
  'deleteSession.confirm': 'Delete permanently',
  'deleteSession.pending': 'Deleting session…',
  'archive.open': 'Show archived sessions',
