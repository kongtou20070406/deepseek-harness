...
| [`pi-idea-context/`](pi-idea-context/README.md) | 基础 profile 的选择性科研上下文 overlay | 替换 compaction provider |
| [`pi-idea-headless/`](pi-idea-headless/README.md) | Pi-Idea headless profile 的根域 compaction 选择层 | —（仅 patch） |
