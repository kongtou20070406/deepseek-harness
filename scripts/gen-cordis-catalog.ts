...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ResearchAuthorityProposal: 'compaction.md',
  ResearchAuthorityProvider: 'compaction.md',
  ResearchContextGoal: 'compaction.md',
  ResearchContextInheritanceProjection: 'compaction.md',
  ResearchContextProjection: 'compaction.md',
  ResearchContextView: 'compaction.md',
  ResearchHandoffCandidate: 'compaction.md',
  ResearchHandoffInput: 'compaction.md',
  ResearchRetrievalProvider: 'compaction.md',
  ResearchStateProjection: 'compaction.md',
  ResearchWorkerContextView: 'compaction.md',
  WorkingStateInput: 'compaction.md',
